                                    ...
                                    <div class="col-lg-6">
                                        <div class="blog-list-widget">
                                            <div class="list-group">
                                                <a href="/show-article.php?aid=<? echo $prevRow['art_id'];?>" class="list-group-item list-group-item-action flex-column align-items-start">
...
?>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="blog-list-widget">
                                            <div class="list-group">
                                                <a href="/show-article.php?aid=<? echo $nextRow['art_id'];?>" class="list-group-item list-group-item-action flex-column align-items-start">
